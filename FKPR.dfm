object KPR: TKPR
  ...
  object pInput: TPanel
    ...
    object eKoefisien: TwwDBSpinEdit
      Left = 97
      Top = 88
      Width = 56
      Height = 19
      ...
      TabOrder = 3
      UnboundDataType = wwDefault
      OnEnter = eKoefisienEnter
      OnExit = eKoefisienExit
      OnKeyDown = EnterToTab
    end
    object lcNama: TwwDBLookupCombo
      Left = 97
      Top = 16
      Width = 216
      Height = 20
