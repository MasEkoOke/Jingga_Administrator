object User: TUser
  ...
  object pInput: TPanel
    ...
    object cbLevelOpt: TwwDBLookupCombo
      Left = 63
      Top = 88
      Width = 124
      Height = 19
      ...
      Selected.Strings = (
        'Posisi'#9'25'#9'Posisi'#9'F')
      DataField = 'LevelOpt'
      DataSource = FDMC.dsqMUser
      LookupTable = FDMC.qPosisi
      LookupField = 'Posisi'
      ...
      AllowClearKey = False
      ShowMatchText = True
      OnEnter = cbLevelOptEnter
      OnExit = cbLevelOptExit
      OnKeyDown = EnterToTab
      OnNotInList = cbLevelOptNotInList
    end
    object ePassword: TwwDBEdit
      Left = 63
      Top = 64
      Width = 180
      Height = 19
      ...
      WantReturns = False
      WordWrap = False
      OnEnter = ePasswordEnter
      OnExit = ePasswordExit
      OnKeyDown = EnterToTab
    end
    ...
    object eStatus: TwwDBComboBox
      ...
      TabOrder = 4
      UnboundDataType = wwDefault
      OnCloseUp = eStatusCloseUp
      OnEnter = eStatusEnter
      OnExit = eStatusExit
      OnKeyDown = EnterToTab
    end
    object eLogin: TwwDBEdit
      Left = 63
      Top = 40
      Width = 180
      Height = 19
    ...
    object chkPass: TCheckBox
      ...
      ParentFont = False
      TabOrder = 7
      OnClick = chkPassClick
    end
    object cbLevel: TwwDBComboBox
      Left = 63
      Top = 88
      Width = 124
      Height = 19
      ...
      TabOrder = 3
      UnboundDataType = wwDefault
      OnCloseUp = cbLevelCloseUp
      OnEnter = cbLevelEnter
      OnExit = cbLevelExit
      OnKeyDown = EnterToTab
    end
  end
