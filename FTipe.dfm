object Tipe: TTipe
  ...
  object pnlButton: TPanel
    ...
    object cbLProyek: TwwDBLookupCombo
      ...
      OnEnter = cbLProyekEnter
      OnExit = cbLProyekExit
    end
  ...
  object pInput: TPanel
    ...
    object cbProyek: TwwDBLookupCombo
      ...
      DropDownAlignment = taLeftJustify
      Selected.Strings = (
        'NamaProyek'#9'60'#9'NamaProyek'#9'F')
      DataField = 'IdProyek'
      DataSource = FDMC.dsqMTipe
      LookupTable = FDMC.tProyek
      LookupField = 'IdProyek'
